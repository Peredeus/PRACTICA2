...
**La complejidad de este algoritmo corresponde a una notacion BIG O(n)**
...
|x|valores|resultado|
|-|-|-|
|4|[1, 2, 4, 7, 9]|**VERDADERO**|
|9|[1, 3, 5, 6, 7]|**FALSO**|
|3|[5, 6, 7, 8, 9, 10]|**FALSO**|


##### Complejidad
Escribe en esta sección la complejidad computacional que coresponde con el algoritmo anterior en las diferentes notaciones que creas correspondientes (*O* y/o Ω y/o Θ).

**La complejidad de este algoritmo seria BIG O(n)**
...
|-|-|-|
|[1, 2, 3]|[1, 2, 3, 4, 5]|**VERDADERO**|
|[2, 4]|[7, 5, 2, 8, 3]|**FALSO**|
|[3, 5, 2]|[6, 5, 3, 7, 1, 2]|**VERDADERO**|
